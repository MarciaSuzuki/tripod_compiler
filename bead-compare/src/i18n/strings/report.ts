...
export const report = {
  "pt-BR": {
    ...
    "report.facts.recorded_at": "Gravado em",
    ...
    "report.facts.tape_hash": "Hash da fita",
    ...
    "report.carried.title": "Correções pedidas em A",
    "report.carried.intro": "Cada correção pedida em A foi levada ao ponto correspondente em B.",
    "report.carried.empty": "Nenhuma correção em aberto em A.",
  ...
  en: {
    ...
    "report.facts.tape_hash": "Tape hash",
