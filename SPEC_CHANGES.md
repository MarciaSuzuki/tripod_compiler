...
- **Status:** APPLIED (compiler, gate board green: 155 tests · validate 6/6 FOR_MODEL + 6/6 CL · check-drift clean · lint/coverage/id-check/gold-diff exit 0) 2026-06-06 — PR + merge pending
...
- **Status:** APPLIED (compiler-side; gate board green; PR open) — merge pending Marcia.
