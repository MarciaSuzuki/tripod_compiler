...
<div style="display:flex;justify-content:space-between;align-items:baseline;gap:12px;flex-wrap:wrap;">
  ...
  ${renderFeedbackButtons(formCfg, { pericope: 'Meaning Ecosystem — Emotion method', artifact: 'The website itself' })}
</div>
...
SIL <i>Journal of Translation</i> 20(2), 2024, pp. 21–62.</p></div>`;
  ...
  return atlasLayout({
    ...
    relRoot: '../',
    crumbs: `<h1 style="margin:.25em 0 0;font-size:16px;"><a href="index.html">Meaning Ecosystem</a> · Emotion</h1>`,
    contentHtml: content,
    stats,
  });
}
