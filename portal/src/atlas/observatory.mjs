...
<div style="display:flex;justify-content:space-between;align-items:baseline;gap:12px;flex-wrap:wrap;">
  ...
  ${renderFeedbackButtons(formCfg, { pericope: 'Meaning Ecosystem — Vocabulary Observatory', artifact: 'The website itself' })}
</div>
...
<div class="books">
  ...
  <div class="bookcard"><div class="bt"><h2 style="font-size:16px;color:var(--champagne);">L3 — registry</h2></div>
    ...
    Per-book casts and the global banks — browsable in the <a href="index.html">Meaning Ecosystem</a> registry pages.</div></div>
</div>
...
${scNodes.map(ledgerRow).join('\n')}
  ...
  return atlasLayout({
    ...
    relRoot: '../',
    crumbs: `<h1 style="margin:.25em 0 0;font-size:16px;"><a href="index.html">Meaning Ecosystem</a> · Vocabulary Observatory</h1>`,
    contentHtml: content,
    stats,
  });
}
