...
- P07-SC-0064-ARC-RULING-LOG: promoted 2 value(s) [arc_element:PROVISION_BROUGHT_HOME, arc_element:REDEEMER_RECOGNITION] → _spec/approved-enumerations.json (SC-0064)
- P09-SC-0064-ARC-RULING-LOG: promoted 3 value(s) [arc_element:NEARER_REDEEMER_DISCLOSURE, arc_element:PLAN_EXECUTION, arc_element:WING_PETITION] → _spec/approved-enumerations.json (SC-0064)
- P10-SC-0064-ARC-RULING-LOG: promoted 2 value(s) [arc_element:EMPTYING_REVERSED, arc_element:SECRECY_INJUNCTION] → _spec/approved-enumerations.json (SC-0064)
- P11-SC-0064-ARC-RULING-LOG: promoted 5 value(s) [arc_element:ATTESTATION_BY_SANDAL, arc_element:GATE_COURT_CONVENED, arc_element:REDEMPTION_DECLINED, arc_element:REDEMPTION_OFFER, arc_element:STAGED_DISCLOSURE] → _spec/approved-enumerations.json (SC-0064)
- P12-SC-0064-ARC-RULING-LOG: promoted 3 value(s) [arc_element:COMMUNITY_WITNESS_ATTESTATION, arc_element:DEAD_NAME_RAISED, arc_element:PUBLIC_REDEMPTION_DECLARATION] → _spec/approved-enumerations.json (SC-0064)
- P13-SC-0064-ARC-RULING-LOG: promoted 4 value(s) [arc_element:BIRTH_OF_HEIR, arc_element:COMMUNAL_NAMING, arc_element:DIVINE_GIFT_OF_CONCEPTION, arc_element:MARRIAGE_CONSUMMATED] → _spec/approved-enumerations.json (SC-0064)
- P14-SC-0064-ARC-RULING-LOG: promoted 2 value(s) [arc_element:GENEALOGICAL_DESCENT, arc_element:LINE_TERMINUS_REACHED] → _spec/approved-enumerations.json (SC-0064)
- J01-SC-0064-ARC-RULING-LOG: promoted 3 value(s) [arc_element:DIVINE_COMMISSION, arc_element:FLIGHT_FROM_PRESENCE, arc_element:REFUSAL_OF_COMMISSION] → _spec/approved-enumerations.json (SC-0064)
- J02-SC-0064-ARC-RULING-LOG: promoted 10 value(s) [arc_element:CREW_CRISIS_RESPONSE, arc_element:DIVINE_PURSUIT_BY_STORM, arc_element:EXPOSURE_BY_LOT, arc_element:HURLING_OVERBOARD, arc_element:PAGAN_WORSHIP, arc_element:PROVIDENTIAL_SWALLOWING, arc_element:RESCUE_ATTEMPT_FAILS, arc_element:SELF_CONFESSION, arc_element:SELF_SURRENDER, arc_element:STORM_STILLED] → _spec/approved-enumerations.json (SC-0064)
- J03-SC-0064-ARC-RULING-LOG: promoted 6 value(s) [arc_element:TEMPLE_TURN, arc_element:DESCENT_INTO_THE_DEEP, arc_element:LIFT_FROM_THE_PIT, arc_element:RESCUE_DECLARED, arc_element:SALVATION_THESIS, arc_element:THANKSGIVING_VOW] → _spec/approved-enumerations.json (SC-0064)
- J04-SC-0064-ARC-RULING-LOG: promoted 7 value(s) [arc_element:DELIVERANCE_TO_DRY_LAND, arc_element:DIVINE_RELENTING, arc_element:MASS_REPENTANCE, arc_element:OBEDIENT_DEPARTURE, arc_element:ORACLE_PROCLAMATION, arc_element:RECOMMISSION, arc_element:ROYAL_DECREE] → _spec/approved-enumerations.json (SC-0064)
- J05-SC-0064-ARC-RULING-LOG: promoted 9 value(s) [arc_element:ANGER_AT_DIVINE_MERCY, arc_element:APPOINTED_OBJECT_LESSON, arc_element:ARGUMENT_FROM_LESSER_TO_GREATER, arc_element:DEATH_WISH, arc_element:DIVINE_PROBING_QUESTION, arc_element:LOSS_OF_COMFORT, arc_element:UNANSWERED_QUESTION_CLOSE, arc_element:WITHDRAWAL_TO_WATCH, arc_element:MOTIVE_DISCLOSED] → _spec/approved-enumerations.json (SC-0064)
- SC-0072-PHASE4-CLEANUP: promoted 6 value(s) [action:GAVE, action:BROUGHT_OUT, action:TURNED_ASIDE, action:SAT, action:CRIED, action:TOLD] → _spec/approved-enumerations.json (SC-0072) — decompose-driven: the Phase-4 cleanup decomposed prose action-slot clauses into governed event-beat verbs (DREW_OFF_SANDAL already approved); re-pinned v0.19→v0.20.
- SC-0078-MODALITY: seeded the NEW `status` axis with 6 value(s) [status:PERMITTED, status:FORESEEN, status:RECALLED, status:COUNTERFACTUAL, status:NORM, status:HABITUAL] → _spec/approved-enumerations.json `axes.status` (SC-0078) — ruling-seeded (Marcia ruled the L3 modality model, option 1), not corpus-promoted; ASSERTED is the unmarked default and is deliberately NOT seeded. `status` is convergent bounded-open (drifts like proposition_kind); re-pinned v0.20→v0.21. PAIRED closed-list growth (not tracked in this registry): SPEECH_ACT 26→33 in validation-rules.json `closed_lists` (+PROPOSES_COURSE_OF_ACTION, PETITIONS_FOR_GRANT, ASKS_DELIBERATIVE_QUESTION, PRESCRIBES_AS_LAW, ADVISES_COURSE_OF_ACTION, RESOLVES_TO_ACT, ALLEGES_AGAINST), now engine-enforced at the component level (A2 make-impossible). See SPEC_CHANGES.md SC-0078 + docs/SC-0078-APPLY-RECORD.md.
- SC-0079-ESTHER-COMPILE: promoted 68 value(s) [action:ANNIHILATE, action:DESTROY, action:KILL, action:PLUNDER, arc_element:ACCUSATION_LAID, arc_element:CONSPIRACY_EXPOSED, arc_element:ENEMY_STRUCK, arc_element:FAVOR_GRANTED, arc_element:FESTIVAL_FOUNDED, arc_element:GREAT_REVERSAL, arc_element:PLEA_FOR_LIFE, arc_element:PUBLIC_FEAST, arc_element:PUBLIC_HONOR, arc_element:RECORD_SEALED, arc_element:RESOLVE_TO_ACT, arc_element:ROYAL_RAGE, arc_element:SEARCH_SET_IN_MOTION, communicative_function_element:ACCUSES, communicative_function_element:BINDS, communicative_function_element:ELEVATES, communicative_function_element:EXPLAINS, communicative_function_element:FIXES, communicative_function_element:GRANTS, communicative_function_element:PUBLISHES, communicative_function_element:RECORDS, communicative_function_element:REVERSES, communicative_function_element:STATES_DANGER, communicative_function_element:TALLIES, context_element:PERIL_CONTEXT, context_element:POLITICAL_CONTEXT, pace_element:ACCELERATES, pace_element:ACCUMULATES, proposition_kind:GRANTED, proposition_kind:WENT_OUT, proposition_kind:WRATH_SUBSIDED, role_in_scene_being:ACCUSER, role_in_scene_being:ADVERSARY, role_in_scene_being:ADVISERS, role_in_scene_being:CONSPIRATOR, role_in_scene_being:COURIERS, role_in_scene_being:DELIVERED_PEOPLE, role_in_scene_being:GATE_SITTER, role_in_scene_being:GUARDIAN, role_in_scene_being:HONORED_ONE, role_in_scene_being:PROVINCIAL_OFFICIALS, role_in_scene_being:QUEEN, role_in_scene_being:REFUSER, role_in_scene_being:SCRIBES, role_in_scene_being:SLAIN_FOES, role_in_scene_being:SLAIN_SONS, role_in_scene_being:THREATENED_PEOPLE, role_in_scene_being:WARD, scene_kind:AUDIENCE_SCENE, scene_kind:AUTHORITY_GRANT_SCENE, scene_kind:CONSPIRACY_DISCLOSURE_SCENE, scene_kind:EXPOSURE_SCENE, scene_kind:FESTIVAL_FOUNDING_SCENE, scene_kind:GATE_CONFRONTATION_SCENE, scene_kind:INTAKE_SCENE, scene_kind:LOT_CASTING_SCENE, scene_kind:REVERSAL_SCENE, scene_kind:SLEEPLESS_NIGHT_SCENE, tone_element:CEREMONIAL, tone_element:COLD, tone_element:DECISIVE, tone_element:JUBILANT, tone_element:SETTLED, tone_element:TAUT] → _spec/approved-enumerations.json (SC-0079) — the Esther seed-expansion compile (E01–E18): Marcia's option-1 promote ruling 2026-06-28 with the action=4 amendment (the decree tricolon DESTROY/KILL/ANNIHILATE stays 3 distinct verbs + PLUNDER); forks folded SOVEREIGN→KING, PETITIONER→SUPPLIANT, MATTER_OF_FACT→ECONOMICAL; per-value pericope provenance carried in the enum entries (first_seen/approved_in/sc_ref). PAIRED quarantine growth: quarantined-vocabulary.json 0.3.0→0.4.0 (+226 parked: table QUARANTINE + surgical per-array dedup-by-parking incl. the scene #33/#34 reverts Marcia ruled kept-parked). Re-pinned v0.21→v0.22. See SPEC_CHANGES.md SC-0079.
