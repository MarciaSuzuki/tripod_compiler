...
# J01 — Jonah 1:1–3 — COMPILATION-LOG (skeleton gap report)
...
```json
{
  ...
  "confidence_overall_note": "Deterministic skeleton from the approved Meaning Map. 7 beings + 3 place codes extracted, 9 flags carried, 45 judgment gaps deferred. Extract-only: no controlled-vocabulary values assigned by the compiler.",
  "compilation_decisions": [
    {
      "decision_id": "P01-D1",
      "decision": "Deterministically compiled a FOR_MODEL skeleton from the approved Meaning Map.",
      "description": "Extracted header/classification, scene + entity IDs + presence, verse-ranges, significant_absence, communicative purpose, proposition anchors/scene-links/cross-refs, and Section-5 concept/figure flags. 45 judgment fields left as typed placeholders for Agent 3. No values invented (extract-only)."
    }
  ],
  ...
  "known_limitations": [
    "Deterministic skeleton (tripod compile): 45 judgment gaps remain as typed __TODO__ placeholders carrying their source-prose span.",
    "Judgment gaps by field — role_in_scene:7, referential_form:7, proposition_kind:5, event_specific_slots:5, inter_proposition_links:5, scene_link:5, scene_kind:2, book_context_ref:1, register_overrides:1, arc_elements:1, context_elements:1, tone_elements:1, pace_elements:1, communicative_function_elements:1, beings_in_scene:1, (granularity):1.",
    "Propositions are at MEANING-MAP granularity (5); the FOR_MODEL may decompose multi-event propositions further (judgment, Agent 3).",
