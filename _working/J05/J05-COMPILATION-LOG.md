...
```json
{
  ...
  "confidence_overall_note": "Deterministic skeleton from the approved Meaning Map. 11 beings + 3 place codes extracted, 2 flags carried, 101 judgment gaps deferred. Extract-only: no controlled-vocabulary values assigned by the compiler.",
  ...
  "known_limitations": [
    ...
    "Judgment gaps by field — proposition_kind:21, event_specific_slots:21, inter_proposition_links:21, role_in_scene:11, referential_form:11, scene_kind:4, object_id:4, book_context_ref:1, register_overrides:1, arc_elements:1, context_elements:1, tone_elements:1, pace_elements:1, communicative_function_elements:1, (granularity):1.",
