...
# P07 — Ruth 2:17-23 — COMPILATION-LOG (skeleton gap report)
...
```json
{
  ...
  "confidence_overall_note": "Deterministic skeleton from the approved Meaning Map. 15 beings + 8 place codes extracted, 19 flags carried, 94 judgment gaps deferred. Extract-only: no controlled-vocabulary values assigned by the compiler.",
  ...
  "known_limitations": [
    "Deterministic skeleton (tripod compile): 94 judgment gaps remain as typed __TODO__ placeholders carrying their source-prose span.",
    "Judgment gaps by field — proposition_kind:16, event_specific_slots:16, inter_proposition_links:16, role_in_scene:15, referential_form:15, scene_kind:4, beings_in_scene:2, book_context_ref:1, register_overrides:1, arc_elements:1, context_elements:1, tone_elements:1, pace_elements:1, communicative_function_elements:1, significant_absence:1, object_id:1, (granularity):1.",
