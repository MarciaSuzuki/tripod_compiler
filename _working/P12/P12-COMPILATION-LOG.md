...
# P12 — Ruth 4:9-12 — COMPILATION-LOG (skeleton gap report)
...
```json
{
  ...
  "confidence_overall_note": "Deterministic skeleton from the approved Meaning Map. 18 beings + 5 place codes extracted, 30 flags carried, 79 judgment gaps deferred. Extract-only: no controlled-vocabulary values assigned by the compiler.",
  ...
  "known_limitations": [
    "Deterministic skeleton (tripod compile): 79 judgment gaps remain as typed __TODO__ placeholders carrying their source-prose span.",
    "Judgment gaps by field — role_in_scene:18, referential_form:18, proposition_kind:11, event_specific_slots:11, inter_proposition_links:11, scene_kind:2, book_context_ref:1, register_overrides:1, arc_elements:1, context_elements:1, tone_elements:1, pace_elements:1, communicative_function_elements:1, (granularity):1.",
    "Propositions are at MEANING-MAP granularity (11); the FOR_MODEL may decompose multi-event propositions further (judgment, Agent 3).",
