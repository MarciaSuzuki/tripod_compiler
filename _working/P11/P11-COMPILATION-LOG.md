...
# P11 — Ruth 4:1-8 — COMPILATION-LOG (skeleton gap report)
...
```json
{
  ...
  "confidence_overall_note": "Deterministic skeleton from the approved Meaning Map. 15 beings + 6 place codes extracted, 37 flags carried, 89 judgment gaps deferred. Extract-only: no controlled-vocabulary values assigned by the compiler.",
  ...
  "known_limitations": [
    "Deterministic skeleton (tripod compile): 89 judgment gaps remain as typed __TODO__ placeholders carrying their source-prose span.",
    "Judgment gaps by field — role_in_scene:15, referential_form:15, proposition_kind:15, event_specific_slots:15, inter_proposition_links:15, scene_kind:4, book_context_ref:1, register_overrides:1, arc_elements:1, context_elements:1, tone_elements:1, pace_elements:1, communicative_function_elements:1, beings_in_scene:1, place_id:1, (granularity):1.",
    "Propositions are at MEANING-MAP granularity (15); the FOR_MODEL may decompose multi-event propositions further (judgment, Agent 3).",
