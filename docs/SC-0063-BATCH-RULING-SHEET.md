...
Total declared mints: 232 across 6 axes

### Axis `proposition_kind` — 72 proposed value(s)

- [ ] **ACQUIRED** (P12) — MM P2/P3: 'I have bought all that was Elimelech's... I have bought Ruth' — the redemption-purchase; no existing proposition_kind names a legal acquisition/redem
- [ ] **ANGER_KINDLED** (J05) — P1: 'it was evil to Jonah... a great evil... burning anger.' No approved proposition_kind names becoming angry.
- [ ] **ANSWERED** (J02, J05) — "he answers: lift me and hurl me into the sea" — a response to the crew's question that is itself a directive counsel.
- [ ] **APPOINTED** (J02, J05) — "YHWH appoints a great fish to swallow Jonah" — the manah/appoint verb.
- [ ] **APPROACHED** (P09, J02) — MM P4: 'she came softly, uncovered the place of his feet, and lay down' — a multi-action approach with no approved proposition_kind fit.
...
- [ ] **EMBARKED** (J01) — MM P5: 'paying / going down into it / to sail / with the crew / away from before YHWH' — boarding the vessel to flee; no approved proposition_kind names embarka
- [ ] **ENGULFED** (J03, J03) — P4: 'the flood was all around me; all your breakers and your waves passed over me' — no approved kind covers engulfment.
- [ ] **FASTED** (J04) — 'They call a fast and put on sackcloth, from the greatest of them to the least of them.'
- [ ] **FATHERED** (P14, P14, P14, P14, P14, P14, P14, P14, P14) — MM P2–P10: the repeated "X fathered Y" genealogical formula; no approved proposition_kind names a begetting event.
- [ ] **FEARED** (J02, J02) — "the sailors are afraid; each cries to his own god" — first step of the fear escalation.
- [ ] **FLED** (J01) — MM P3: 'getting up / to flee / to Tarshish / away from before YHWH' — a flight; no approved proposition_kind names fleeing (ROSE and DEPARTED understate the ref
...
- [ ] **HURLED** (J02, J02, J02) — "hurling ... YHWH hurled a great wind at the sea" — the hetil/hurl verb that recurs four times in the pericope.
...
- [ ] **LAY_DOWN** (P09, P10) — MM P3: 'he came to lie down at the end of the grain heap' — a lying-down event with no approved proposition_kind fit.
...
- [ ] **MEASURED_OUT** (P10) — MM P5: 'measuring — measured six measures of barley — laid it on her.' FIG_0152 foregrounds the measuring with the measure-unit deliberately unspecified; GAVE/H
- [ ] **NAME_NOT_CUT_OFF** (P12) — MM P5: 'so that the name of the dead is not cut off from his kindred and from the gate of his place' (FIG_0110, living-and-dead formula); distinct negative beat
- [ ] **NAME_RAISED** (P12) — MM P4: 'to raise up the name of the dead upon his inheritance' (FIG_0002, the raise-up-the-name formula enacted); no existing proposition_kind covers name-prese
- [ ] **PASSED_BY** (P11) — MM P2: 'the redeemer of whom Boaz had spoken is passing by' — incidental passage with no approved kind.
- [ ] **PRAYED** (J02, J05) — "Jonah prays to YHWH his God from the belly of the fish" — the prayer the prophet never prayed on deck.
...
- [ ] **SHOWED** (P10) — MM P10: 'showing — what did she show? these six measures of barley.' The gift is laid out as evidence; no approved kind covers displaying/presenting an object a
...
- [ ] **WENT_DOWN** (P09, J01, J02) — MM P1: 'she went down (yarad) to the threshing floor and did all her mother-in-law commanded' — a descent-and-compliance event with no approved proposition_kind
...
### Axis `role_in_scene_being` — 60 proposed value(s)
...
- [ ] **CREW** (J02, J02, J02, J02) — "the sailors" / "the men" — the ship's working crew, with no approved maritime collective role in the list.
...
- [ ] **DECEASED_KIN** (P07) — MM S3 3A: 'the dead of the household... those the blessing keeps inside the reach of hesed' — Naomi's dead husband and sons, named only as 'the dead'; no approv
- [ ] **DECEASED_KINSMAN** (P11, P11) — MM: Elimelech is the dead kinsman whose line the redeeming serves; no approved role for the deceased ancestor-of-the-matter.
...
- [ ] **FUGITIVE** (J02, J02, J02, J02, J02) — "the runaway ... the prophet fleeing YHWH" — Jonah's scene function throughout the pericope; no approved fit.
- [ ] **GRANDMOTHER** (P13, P13) — MM Scene 2/3: 'the grandmother' to whom the child is reckoned (the once-empty widow now holding the line's future); no approved role captures the grandmother fu
...
- [ ] **LINEAGE_REFERENT** (P13) — MM Scene 3: Jesse and David are 'the names the narrator reaches to past the story' — forward genealogical referents; ANCESTOR is wrong-direction and ERA_REFEREN
- [ ] **LINE_TERMINUS** (P14) — MM 3A/2.4: B26 is "the line's arrival; David the book's destination" — the terminal name the whole genealogy exists to reach; no approved role_in_scene_being na
- [ ] **LIVESTOCK** (J04) — 'man and beast, herd and flock ... covered with sackcloth' — the city's animals made part of its repentance.
- [ ] **NEARER_REDEEMER** (P11, P11, P11, P11) — MM S1: 'kinsman of Elimelech's line, nearer in the queue than Boaz (3:12)'; the queue-priority role is distinct from the generic REDEEMER_KIN.
- [ ] **NOBLES** (J04) — 'by decree of the king and his nobles' — co-issuers of the edict.
- [ ] **PATRONYMIC_REFERENT** (J01, J01) — MM 3A: Amittai 'fixes who Jonah is by naming his father'; he functions only as an identity anchor, like the approved ERA_REFERENT but for parentage.
- [ ] **POTENTIAL_SUITORS** (P09) — MM 3A-S3: 'the young men of marrying age, poor or rich; none of them chosen' — their scene function is the unchosen marital alternative, with no approved role_i
- [ ] **PROPHET** (J04, J04, J04) — Jonah's book-spanning function as the one YHWH sends to call out to Nineveh.
- [ ] **REDEMPTION_OFFEROR** (P11, P11) — MM S2: 'the one who lays out the field-matter before the court'; no approved role for the one tendering a redemption offer.
- [ ] **RESPONDENT** (J05) — MM S4 role prose: 'the defiant answerer — angry enough to die — then the silent one.'
- [ ] **SELLER** (P11, P11) — MM S2: 'the seller — the widow whose hand holds Elimelech's portion'; the seller function is not among approved roles.
...
- [ ] **SUPPLIANT** (J03, J03, J03) — Scene 1 role prose: 'the one praying — he called from his distress and was answered.' No approved role covers a praying suppliant.
- [ ] **TOWNSWOMEN** (P13, P13) — MM Scene 2/3 'the women' / 'the neighbor-women' act as the female counterpart to the men's gate-blessing (FIG_0187); approved TOWNSPEOPLE is gender-blind and FE
...
- [ ] **WITNESSING_ASSEMBLY** (P12) — MM 3A: 'the wider assembly called to witness alongside the elders'; TOWNSPEOPLE/PEOPLE name the group but not its scene-defining witnessing function ('you are w
- [ ] **WITNESSING_ELDERS** (P11, P11, P12) — MM S1: 'the seated witnesses who make the gate a court'; no approved role for legal witnesses.

### Axis `arc_element` — 58 proposed value(s)
...
- [ ] **DEAD_NAME_RAISED** (P12) — MM 2.1/2.4: 'to raise up the name of the dead upon his inheritance, so that the name of the dead is not cut off' — the raise-up-the-name beat, distinct from the
...
- [ ] **DIVINE_COMMISSION** (J01) — MM 2.1/2.4: the passage opens with YHWH's word/charge to go to Nineveh — the commission the rest of the book answers; no approved arc token names a divine commi
...
- [ ] **EMPTYING_REVERSED** (P10) — MM 2.4 names 'the structural turn from emptying to filling, carried in six measures of barley' — Naomi's 1:21 reqam answered negated. EMPTYING is approved for t
- [ ] **EXPOSURE_BY_LOT** (J02) — "the lot finds Jonah" — the runaway is exposed.
- [ ] **FLIGHT_FROM_PRESENCE** (J01) — MM 2.1: Jonah runs the opposite way 'away from before YHWH' — the flight is the structural turn; approved DEPARTURE connotes ordinary leave-taking, not flight f
...
- [ ] **LINE_ARRIVAL_AT_DAVID** (P14) — MM 2.1/2.4: the cadence "tilts toward its last word" and "exists to arrive at David" — the arrival at the terminal name is the arc's burden, with no approved el
...
- [ ] **PROVISION_BROUGHT_HOME** (P07) — MM arc: 'The passage moves from the field to home... carries it into town... hands her the food left over' — a day's gleaning brought home as provision; no appr
- [ ] **PUBLIC_REDEMPTION_DECLARATION** (P12) — MM 2.1: 'Boaz turns... to the whole assembly and declares what he has done... you are witnesses today that I have bought...' — the public legal attestation that
- [ ] **RECOMMISSION** (J04) — 'the word of YHWH comes a second time — the same charge.'
- [ ] **REDEEMER_RECOGNITION** (P07) — MM arc: 'Naomi blesses him by YHWH... and tells Ruth the man is near to them, one of their redeemers' — the redeemer-role recognized for the first time in the b
...
- [ ] **SECRECY_INJUNCTION** (P10) — MM 2.1/2.4: Boaz says the night's one rule out loud — 'let it not be known that the woman came to the floor'; the whole scene closes under this rule of secrecy.
...
### Axis `scene_kind` — 30 proposed value(s)
...
- [ ] **BIRTH_SCENE** (P13) — MM Scene 1 title 'The marriage, the gift, the birth' and 3F centers on the divine gift of conception and the birth of the son; no approved scene_kind covers a b
...
- [ ] **COMMISSION_SCENE** (J01) — MM Scene 1 / 3F: 'Gives the command that the rest of the pericope answers: the caller, the called, the city, and the reason' — a divine commissioning; no approv
...
- [ ] **DELIVERANCE_SCENE** (J03, J04) — Scene 3 title/3F: 'Touches bottom so the lift can be measured... you brought my life up from the pit.'
...
- [ ] **GLEANING_SCENE** (P07) — MM S1: 'Ruth gleans in the field until evening, beats out what she gathered, and it comes to about an ephah' — a narrated gleaning/work scene with no approved s
...
- [ ] **NIGHT_APPROACH_SCENE** (P09) — MM 3F-S1: 'Executes the plan to the letter and sets the night's stage' — a wordless nighttime approach scene with no approved fit (MEAL_SCENE/INSTRUCTION_SCENE 
- [ ] **PROCLAMATION_SCENE** (J04) — 'he cries out: forty more days, and Nineveh is overthrown' — a public oracle proclaimed in the city.
- [ ] **PROVISION_HOMECOMING_SCENE** (P07) — MM S2: 'Ruth lifts the grain and comes into the town. Her mother-in-law sees what she gleaned. Then Ruth brings out and gives her what she had left over' — brin
- [ ] **REDEEMER_RECOGNITION_SCENE** (P07) — MM S3 3F: 'The turn of the passage: at the name Boaz, Naomi recognizes a redeemer' — a dialogue scene whose spine is the kinship-role recognition; no approved s
...
### Axis `action` — 8 proposed value(s)

- [ ] **AROSE** (J04, J04) — 'Jonah gets up and goes' — the plain wayyaqom rising, no return sense.
- [ ] **DONNED_SACKCLOTH** (J04) — 'covers himself with sackcloth.'
- [ ] **DREW_OFF_SANDAL** (P11) — MM P15/Scene 4: the redeemer 'draws off his sandal' as the attestation act; no approved action covers the sandal-drawing gesture, and HANDED is avoided because 
...
### Axis `tone_element` — 4 proposed value(s)
...
- [ ] **IRONIC** (J02) — "the irony rides on top of it ... the prophet of YHWH is fast asleep below while every pagan aboard is praying" — irony is named as the passage's pervasive tone
