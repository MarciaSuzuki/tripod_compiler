...
```json
{
  ...
  "level_2_scenes": [
    ...
    },
    {
      ...
      "objects_in_scene": {
        "_note": "The law (I2 / dat, a registered INSTITUTION) Esther resolves to break rides as bare-atom content in Prop 18 (against THE_LAW); the FOR_MODEL scene containers have no institution slot. No persistent registry object in this scene.",
        "entries": null
      },
      "times_in_scene": {
