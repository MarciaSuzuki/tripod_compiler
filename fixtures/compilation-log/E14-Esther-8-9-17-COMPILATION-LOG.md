...
# E14 — Esther 8:9–17 — COMPILATION-LOG (skeleton gap report)
...
```json
{
  ...
  "confidence_overall_note": "Deterministic skeleton from the approved Meaning Map. 15 beings + 5 place codes extracted, 0 flags carried, 106 judgment gaps deferred. Extract-only: no controlled-vocabulary values assigned by the compiler.",
  ...
  "known_limitations": [
    ...
    "Judgment gaps by field — proposition_kind:17, event_specific_slots:17, inter_proposition_links:17, role_in_scene:15, referential_form:15, being_id:7, object_id:5, scene_kind:4, book_context_ref:1, register_overrides:1, arc_elements:1, context_elements:1, tone_elements:1, pace_elements:1, communicative_function_elements:1, place_id:1, (granularity):1.",
