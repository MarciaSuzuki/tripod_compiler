...
# E17 — Esther 9:20–32 — COMPILATION-LOG
...
```json
{
  ...
  "compilation_decisions": [
    ...
    },
    {
      ...
      "description": "P10 (9:29): PRESCRIBES_AS_LAW KEPT as ruled — the second Purim letter is the enacting written act, consistent with the Part-1 letter-acts register ruling; the audit's drop-note was reversed by Marcia's ruling. Card: tripod-eval-artifacts/ESTHER-SPEECH-ACT-DECISION-CARD.md."
    }
  ],
