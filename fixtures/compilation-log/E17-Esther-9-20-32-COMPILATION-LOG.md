...
# E17 — Esther 9:20–32 — COMPILATION-LOG (skeleton gap report)
...
```json
{
  ...
  "confidence_overall_note": "Deterministic skeleton from the approved Meaning Map. 12 beings + 2 place codes extracted, 0 flags carried, 75 judgment gaps deferred. Extract-only: no controlled-vocabulary values assigned by the compiler.",
  ...
  "known_limitations": [
    ...
    "Judgment gaps by field — proposition_kind:13, event_specific_slots:13, inter_proposition_links:13, role_in_scene:12, referential_form:12, scene_kind:3, book_context_ref:1, register_overrides:1, arc_elements:1, context_elements:1, tone_elements:1, pace_elements:1, communicative_function_elements:1, being_id:1, (granularity):1.",
    "Propositions are at MEANING-MAP granularity (13); the FOR_MODEL may decompose multi-event propositions further (judgment, Agent 3).",
