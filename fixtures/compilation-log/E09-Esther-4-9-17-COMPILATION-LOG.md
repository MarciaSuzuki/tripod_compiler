...
# E09 — Esther 4:9–17 — COMPILATION-LOG (skeleton gap report)
...
```json
{
  ...
  "confidence_overall_note": "Deterministic skeleton from the approved Meaning Map. 16 beings + 1 place codes extracted, 0 flags carried, 117 judgment gaps deferred. Extract-only: no controlled-vocabulary values assigned by the compiler.",
  ...
  "known_limitations": [
    ...
    "Judgment gaps by field — proposition_kind:21, event_specific_slots:21, inter_proposition_links:21, role_in_scene:16, referential_form:16, scene_kind:4, being_id:3, place_id:3, time_id:3, book_context_ref:1, register_overrides:1, arc_elements:1, context_elements:1, tone_elements:1, pace_elements:1, communicative_function_elements:1, object_id:1, (granularity):1.",
