...
# E13 — Esther 8:1–8 — COMPILATION-LOG (skeleton gap report)
...
```json
{
  ...
  "confidence_overall_note": "Deterministic skeleton from the approved Meaning Map. 15 beings + 0 place codes extracted, 0 flags carried, 117 judgment gaps deferred. Extract-only: no controlled-vocabulary values assigned by the compiler.",
  ...
  "known_limitations": [
    "Deterministic skeleton (tripod compile): 117 judgment gaps remain as typed __TODO__ placeholders carrying their source-prose span.",
    "Judgment gaps by field — proposition_kind:22, event_specific_slots:22, inter_proposition_links:22, role_in_scene:15, referential_form:15, place_id:5, object_id:3, scene_kind:3, book_context_ref:1, register_overrides:1, arc_elements:1, context_elements:1, tone_elements:1, pace_elements:1, communicative_function_elements:1, time_id:1, being_id:1, (granularity):1.",
