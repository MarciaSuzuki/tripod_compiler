...
# E03 — Esther 2:1–4 — COMPILATION-LOG (skeleton gap report)
...
```json
{
  ...
  "confidence_overall_note": "Deterministic skeleton from the approved Meaning Map. 7 beings + 2 place codes extracted, 0 flags carried, 63 judgment gaps deferred. Extract-only: no controlled-vocabulary values assigned by the compiler.",
  ...
  "known_limitations": [
    "Deterministic skeleton (tripod compile): 63 judgment gaps remain as typed __TODO__ placeholders carrying their source-prose span.",
    "Judgment gaps by field — proposition_kind:10, event_specific_slots:10, inter_proposition_links:10, role_in_scene:7, referential_form:7, object_id:4, being_id:3, scene_kind:2, book_context_ref:1, register_overrides:1, arc_elements:1, context_elements:1, tone_elements:1, pace_elements:1, communicative_function_elements:1, time_id:1, beings_in_scene:1, (granularity):1.",
