...
# E05 — Esther 2:19–23 — COMPILATION-LOG
...
```json
{
  ...
  "vocabulary_additions": {
    ...
    "scene_kinds": [
      {
        "value": "CONSPIRACY_DISCLOSURE_SCENE",
        "source": "E05-Esther-2-19-23-MEANING-COORDINATES · SC-0079 fan-out (wf_63e8a4e6-a77, 2026-06-28) + fix-stream B remap (SC-0079-remapping-LOCKED) · ruled by Marcia 2026-06-28 (option 1 + the action=4 amendment)",
        "status": "CONFIRMED",
        "note": "Mechanized from enum v0.22 provenance: axis scene_kind, first_seen E05 (this pericope). Per-axis ruling basis in tripod-eval-artifacts/SC-0079-REMAPPING-QA-HANDOFF.md; dedup + quarantine ledgered in quarantined-vocabulary.json 0.4.0."
      }
    ],
    "presence_values": [],
    "referential_forms": [],
    ...
    "arc_elements": [
      {
        "value": "CONSPIRACY_EXPOSED",
        "source": "E05-Esther-2-19-23-MEANING-COORDINATES · SC-0079 fan-out (wf_63e8a4e6-a77, 2026-06-28) + fix-stream B remap (SC-0079-remapping-LOCKED) · ruled by Marcia 2026-06-28 (option 1 + the action=4 amendment)",
        "status": "CONFIRMED",
        "note": "Mechanized from enum v0.22 provenance: axis arc_element, first_seen E05 (this pericope). Per-axis ruling basis in tripod-eval-artifacts/SC-0079-REMAPPING-QA-HANDOFF.md; dedup + quarantine ledgered in quarantined-vocabulary.json 0.4.0."
      },
      {
        "value": "RECORD_SEALED",
        "source": "E05-Esther-2-19-23-MEANING-COORDINATES · SC-0079 fan-out (wf_63e8a4e6-a77, 2026-06-28) + fix-stream B remap (SC-0079-remapping-LOCKED) · ruled by Marcia 2026-06-28 (option 1 + the action=4 amendment)",
    ...
    "communicative_function_elements": [
      {
        ...
        "source": "E05-Esther-2-19-23-MEANING-COORDINATES · SC-0079 fan-out (wf_63e8a4e6-a77, 2026-06-28) + fix-stream B remap (SC-0079-remapping-LOCKED) · ruled by Marcia 2026-06-28 (option 1 + the action=4 amendment)",
        "status": "CONFIRMED",
        "note": "Mechanized from enum v0.22 provenance: axis communicative_function_element, first_seen E05 (this pericope). Per-axis ruling basis in tripod-eval-artifacts/SC-0079-REMAPPING-QA-HANDOFF.md; dedup + quarantine ledgered in quarantined-vocabulary.json 0.4.0."
      }
    ],
    "role_in_scene_beings": [
      {
        ...
        "source": "E05-Esther-2-19-23-MEANING-COORDINATES · SC-0079 fan-out (wf_63e8a4e6-a77, 2026-06-28) + fix-stream B remap (SC-0079-remapping-LOCKED) · ruled by Marcia 2026-06-28 (option 1 + the action=4 amendment)",
        "status": "CONFIRMED",
        "note": "Mechanized from enum v0.22 provenance: axis role_in_scene_being, first_seen E05 (this pericope). Per-axis ruling basis in tripod-eval-artifacts/SC-0079-REMAPPING-QA-HANDOFF.md; dedup + quarantine ledgered in quarantined-vocabulary.json 0.4.0."
      },
      {
        "value": "GATE_SITTER",
        "source": "E05-Esther-2-19-23-MEANING-COORDINATES · SC-0079 fan-out (wf_63e8a4e6-a77, 2026-06-28) + fix-stream B remap (SC-0079-remapping-LOCKED) · ruled by Marcia 2026-06-28 (option 1 + the action=4 amendment)",
