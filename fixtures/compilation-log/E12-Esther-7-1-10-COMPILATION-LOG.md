...
# E12 — Esther 7:1–10 — COMPILATION-LOG (skeleton gap report)
...
```json
{
  ...
  "confidence_overall_note": "Deterministic skeleton from the approved Meaning Map. 16 beings + 1 place codes extracted, 0 flags carried, 104 judgment gaps deferred. Extract-only: no controlled-vocabulary values assigned by the compiler.",
  ...
  "known_limitations": [
    "Deterministic skeleton (tripod compile): 104 judgment gaps remain as typed __TODO__ placeholders carrying their source-prose span.",
    "Judgment gaps by field — proposition_kind:17, event_specific_slots:17, inter_proposition_links:17, role_in_scene:16, referential_form:16, scene_kind:5, place_id:4, object_id:3, book_context_ref:1, register_overrides:1, arc_elements:1, context_elements:1, tone_elements:1, pace_elements:1, communicative_function_elements:1, time_id:1, (granularity):1.",
