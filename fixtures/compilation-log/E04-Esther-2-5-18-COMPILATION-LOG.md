...
```json
{
  ...
  "vocabulary_additions": {
    ...
    "scene_kinds": [
      {
        "value": "INTAKE_SCENE",
        "source": "E04-Esther-2-5-18-FOR-MODEL · SC-0079 fan-out (wf_63e8a4e6-a77, 2026-06-28) + fix-stream B remap (SC-0079-remapping-LOCKED) · ruled by Marcia 2026-06-28 (option 1 + the action=4 amendment)",
        "status": "CONFIRMED",
