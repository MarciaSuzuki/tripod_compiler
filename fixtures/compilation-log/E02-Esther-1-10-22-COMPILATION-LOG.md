...
# E02 — Esther 1:10–22 — COMPILATION-LOG (skeleton gap report)
...
```json
{
  ...
  "confidence_overall_note": "Deterministic skeleton from the approved Meaning Map. 18 beings + 3 place codes extracted, 0 flags carried, 101 judgment gaps deferred. Extract-only: no controlled-vocabulary values assigned by the compiler.",
  ...
  "known_limitations": [
    ...
    "Judgment gaps by field — role_in_scene:18, referential_form:18, proposition_kind:13, event_specific_slots:13, inter_proposition_links:13, object_id:6, being_id:5, scene_kind:4, time_id:2, book_context_ref:1, register_overrides:1, arc_elements:1, context_elements:1, tone_elements:1, pace_elements:1, communicative_function_elements:1, beings_in_scene:1, (granularity):1.",
