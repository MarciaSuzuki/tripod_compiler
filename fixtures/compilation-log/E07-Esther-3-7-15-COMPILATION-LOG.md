...
# E07 — Esther 3:7–15 — COMPILATION-LOG (skeleton gap report)
...
```json
{
  ...
  "confidence_overall_note": "Deterministic skeleton from the approved Meaning Map. 11 beings + 2 place codes extracted, 0 flags carried, 83 judgment gaps deferred. Extract-only: no controlled-vocabulary values assigned by the compiler.",
  ...
  "known_limitations": [
    ...
    "Judgment gaps by field — proposition_kind:14, event_specific_slots:14, inter_proposition_links:14, role_in_scene:11, referential_form:11, being_id:4, scene_kind:3, object_id:2, book_context_ref:1, register_overrides:1, arc_elements:1, context_elements:1, tone_elements:1, pace_elements:1, communicative_function_elements:1, beings_in_scene:1, place_id:1, (granularity):1.",
