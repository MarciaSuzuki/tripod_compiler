...
# E11 — Esther 6:1–14 — COMPILATION-LOG (skeleton gap report)
...
```json
{
  ...
  "confidence_overall_note": "Deterministic skeleton from the approved Meaning Map. 19 beings + 0 place codes extracted, 0 flags carried, 167 judgment gaps deferred. Extract-only: no controlled-vocabulary values assigned by the compiler.",
  "compilation_decisions": [
    {
      "decision_id": "P11-D1",
      "decision": "Deterministically compiled a FOR_MODEL skeleton from the approved Meaning Map.",
      "description": "Extracted header/classification, scene + entity IDs + presence, verse-ranges, significant_absence, communicative purpose, proposition anchors/scene-links/cross-refs, and Section-5 concept/figure flags. 167 judgment fields left as typed placeholders for Agent 3. No values invented (extract-only)."
    }
  ],
  ...
  "known_limitations": [
    "Deterministic skeleton (tripod compile): 167 judgment gaps remain as typed __TODO__ placeholders carrying their source-prose span.",
    "Judgment gaps by field — proposition_kind:33, event_specific_slots:33, inter_proposition_links:33, role_in_scene:19, referential_form:19, place_id:6, being_id:5, object_id:5, scene_kind:4, time_id:2, book_context_ref:1, register_overrides:1, arc_elements:1, context_elements:1, tone_elements:1, pace_elements:1, communicative_function_elements:1, (granularity):1.",
    "Propositions are at MEANING-MAP granularity (33); the FOR_MODEL may decompose multi-event propositions further (judgment, Agent 3).",
