...
# E15 — Esther 9:1–10 — COMPILATION-LOG (skeleton gap report)
...
```json
{
  ...
  "confidence_overall_note": "Deterministic skeleton from the approved Meaning Map. 10 beings + 2 place codes extracted, 0 flags carried, 89 judgment gaps deferred. Extract-only: no controlled-vocabulary values assigned by the compiler.",
  ...
  "known_limitations": [
    ...
    "Judgment gaps by field — proposition_kind:16, event_specific_slots:16, inter_proposition_links:16, role_in_scene:10, referential_form:10, being_id:4, object_id:3, place_id:2, scene_kind:2, book_context_ref:1, register_overrides:1, arc_elements:1, context_elements:1, tone_elements:1, pace_elements:1, communicative_function_elements:1, time_id:1, scene_link:1, (granularity):1.",
    "Propositions are at MEANING-MAP granularity (16); the FOR_MODEL may decompose multi-event propositions further (judgment, Agent 3).",
