...
# E10 — Esther 5:1–14 — COMPILATION-LOG (skeleton gap report)
...
```json
{
  ...
  "confidence_overall_note": "Deterministic skeleton from the approved Meaning Map. 12 beings + 1 place codes extracted, 0 flags carried, 152 judgment gaps deferred. Extract-only: no controlled-vocabulary values assigned by the compiler.",
  ...
  "known_limitations": [
    "Deterministic skeleton (tripod compile): 152 judgment gaps remain as typed __TODO__ placeholders carrying their source-prose span.",
    "Judgment gaps by field — proposition_kind:34, event_specific_slots:34, inter_proposition_links:34, role_in_scene:12, referential_form:12, place_id:5, object_id:4, time_id:4, scene_kind:4, book_context_ref:1, register_overrides:1, arc_elements:1, context_elements:1, tone_elements:1, pace_elements:1, communicative_function_elements:1, being_id:1, (granularity):1.",
    "Propositions are at MEANING-MAP granularity (34); the FOR_MODEL may decompose multi-event propositions further (judgment, Agent 3).",
