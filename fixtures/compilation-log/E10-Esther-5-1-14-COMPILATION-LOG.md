...
# E10 — Esther 5:1–14 — COMPILATION-LOG
...
```json
{
  ...
  "compilation_decisions": [
    {
      ...
      "description": "Extracted header/classification, scene + entity IDs + presence, verse-ranges, significant_absence, communicative purpose, proposition anchors/scene-links/cross-refs, and Section-5 concept/figure flags. 152 judgment fields left as typed placeholders for Agent 3. No values invented (extract-only)."
    },
    {
      "decision_id": "P10-D2",
    ...
    },
    {
      ...
      "description": "P9/P14: the king's ASKED components -> ASKS_INFORMATION_SEEKING_QUESTION (the card's rider); the PETITIONS_FOR_GRANT components -> PROPOSES_COURSE_OF_ACTION (card items 3+4). Note: the card's prose gloss describes Esther's banquet invitation, but the carded targets (the P9/P14 PETITIONS_FOR_GRANT comps) are the king's half-the-kingdom promise components; the prop/comp targets in the card are explicit and were applied as carded — flagged for the Evaluator. Card: tripod-eval-artifacts/ESTHER-SPEECH-ACT-DECISION-CARD.md."
    }
  ],
  "vocabulary_additions": {
    ...
    "scene_kinds": [
      {
        "value": "AUDIENCE_SCENE",
        "source": "E10-Esther-5-1-14-MEANING-COORDINATES · SC-0079 fan-out (wf_63e8a4e6-a77, 2026-06-28) + fix-stream B remap (SC-0079-remapping-LOCKED) · ruled by Marcia 2026-06-28 (option 1 + the action=4 amendment)",
        "status": "CONFIRMED",
        "note": "Mechanized from enum v0.22 provenance: axis scene_kind, first_seen E10 (this pericope). Per-axis ruling basis in tripod-eval-artifacts/SC-0079-REMAPPING-QA-HANDOFF.md; dedup + quarantine ledgered in quarantined-vocabulary.json 0.4.0."
      }
    ],
    "presence_values": [],
    "referential_forms": [],
  ...
  "known_limitations": [
    ...
    "Component records in condition_components carry no speech_act (non-event records: condition/framing components); component speech_act PRESENCE enforcement is consciously deferred to its own SC (SC-0078 A2 is membership-only)."
  ]
}
```
